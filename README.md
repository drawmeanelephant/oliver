...
case-folded label map), block quotes (§5.1 on the container-block stack
with nesting, laziness, and interruption — the architecture for lists),
...
```bash
zig build test    # run all tests (68 tests)
