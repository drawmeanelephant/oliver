...
| application features (filesystem reference resolution, shopping lists, pantry, aisles, images, search, meal plans, `.menu` logic, publication) | deferred | documented as ecosystem conventions (conventions.md), not language; consumers (e.g. Boris) own them. |
